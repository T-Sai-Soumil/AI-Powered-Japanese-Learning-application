...
# Can add persistence easily later!
client = chromadb.Client()

# Create collection. get_collection, get_or_create_collection,
# delete_collection also available!
collection = client.create_collection("all-my-little-listening-comprehension")

# Add docs to the collection. Can also update and delete.
# Row-based API coming soon!
